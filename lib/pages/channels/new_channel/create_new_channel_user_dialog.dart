...
class CreateNewChannelUserDialog extends StatefulWidget {
  final bool isModerator;
  const CreateNewChannelUserDialog({
    super.key,
    required this.isModerator,
  });

  @override
  State<CreateNewChannelUserDialog> createState() =>
      _CreateNewChannelUserDialogState();
}

class _CreateNewChannelUserDialogState
    extends State<CreateNewChannelUserDialog> {
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return ListTile(
                                    ...
                                    subtitle: SelectableText(
                                        '${currentUser.email}\n@${currentUser.nickname} • ${currentUser.phoneNumber}'),
